...
<li><i class='fas fa-sign-out-alt'></i></li>
      ...
      <div className='get-quote-product'>
        ...
        <span className='get-quote-span' ><Link to="/hot_rolled"><div className='get-quote-box_1'></div><h3 className='get-quote-h3' >Hot rolled - HR </h3></Link></span>
          <span className='get-quote-span' ><Link to="/hrpo"><div className='get-quote-box_2'></div><h3 className='get-quote-h3' > HRPO </h3></Link></span>
          <span className='get-quote-span' ><Link to="/cold_rolled"><div className='get-quote-box_3'></div><h3 className='get-quote-h3' >Cold rolled - CR</h3></Link></span>
        </div>
